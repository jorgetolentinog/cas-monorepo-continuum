import { SyncMedicapException } from "../../usecase/sync-medicap-exception/sync-medicap-exception";
import { EventBridgeEvent } from "aws-lambda";
import { EventBridgeWrapperHandler } from "@package/lambda-eventbridge-wrapper/wrapper";
import { z } from "zod";

export class EventMedicapExceptionSynced implements EventBridgeWrapperHandler {
