import { SyncMedicapPreBooking } from "../../usecase/sync-medicap-pre-booking/sync-medicap-pre-booking";
import { EventBridgeEvent } from "aws-lambda";
import { z } from "zod";
import { EventBridgeWrapperHandler } from "@package/lambda-eventbridge-wrapper/wrapper";

export class EventMedicapPreBookingSynced implements EventBridgeWrapperHandler {
