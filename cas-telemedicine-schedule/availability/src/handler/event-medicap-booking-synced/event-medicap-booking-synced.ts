import { SyncMedicapBooking } from "../../usecase/sync-medicap-booking/sync-medicap-booking";
...
export class EventMedicapBookingSynced implements EventBridgeWrapperHandler {
