import { SyncMedicapCalendar } from "../../usecase/sync-medicap-calendar/sync-medicap-calendar";
...
export class EventMedicapCalendarSynced implements EventBridgeWrapperHandler {
